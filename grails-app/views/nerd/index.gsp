		...
		<div id="list-nerd" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
                        ...
                        <g:sortableColumn property="initials" title="${message(code: 'nerd.initials.label', default: 'Initials')}" />
				...
				<g:each in="${nerdInstanceList}" status="i" var="nerdInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                        ...
                        <td>${fieldValue(bean: nerdInstance, field: "initials")}</td>

                        <td><g:formatDate date="${nerdInstance.birthDate}" format="dd-MMM-yyyy" /></td>
