	...
	<body>
		...
		<div id="show-nerd" class="content scaffold-show" role="main">
			...
			<ol class="property-list nerd">
                ...
                <g:if test="${nerdInstance?.initials}">
                    <li class="fieldcontain">
                        <span id="initials-label" class="property-label"><g:message code="nerd.initials.label" default="Initials" /></span>

                        <span class="property-value" aria-labelledby="initials-label"><g:fieldValue bean="${nerdInstance}" field="initials"/></span>
				...
				<li class="fieldcontain">
					<span id="birthDate-label" class="property-label"><g:message code="nerd.birthDate.label" default="Birth Date" /></span>
						...
						<span class="property-value" aria-labelledby="birthDate-label"><g:formatDate date="${nerdInstance?.birthDate}" format="dd-MMM-yyyy" /></span>
